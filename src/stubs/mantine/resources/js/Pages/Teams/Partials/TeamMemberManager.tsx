  ...
  return (
    <div>
          ...
          >
            ...
            {availableRoles.length > 0 ? (
              <div className="col-span-6 lg:col-span-4">
                <Text c="gray">Role</Text>
                {addTeamMemberForm.errors.role && (
                  <Text c="red" className='mt-2'>{addTeamMemberForm.errors.role}</Text>
                )}
      ...
      >
        ...
        <DialogModal.Footer>
          <Button variant="default" onClick={() => setCurrentlyManagingRole(false)}>
            Cancel
          </Button>
      ...
      >
        ...
        <ConfirmationModal.Footer>
          <Button variant='default' onClick={() => setConfirmingLeavingTeam(false)}>
            Cancel
          </Button>
      ...
      >
        ...
        <ConfirmationModal.Footer>
          <Button variant='default' onClick={() => setTeamMemberBeingRemoved(null)}>
            Cancel
          </Button>
